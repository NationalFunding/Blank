...
export default class AccountActivity extends NavigationMixin(LightningElement) {
    ...
    activityResult(result){
        ...
        if(result.data){
            ...
            console.log('Account Activity Data Retrieved');
            this.activity = result.data;
            console.log(this.activity);
            console.log('Account Activities Data: ', result.data.Activities);
